            ...
            {/* <div>
                <div className="row" >
                    <div className="col-md-6 ">
                        <div className=" w-20 mx-3 p-5 my-5 mt-5 d-flex flex-column justify-content-center ">
                ...
                <div className="container">
                    ...
                    <div className=" w-90 m-5 text-center d-flex mt-5">
                        <div className='text-center'>
                            <img className="img-fluid p-4 mx-3 my-2 " style={{ height: '200px', width: '300px' }} src="./pizza-hut.svg" alt="" />
                        </div>
                        <div className='text-center'>
                            <img className="img-fluid p-2 mx-3" style={{ height: '200px', width: '300px' }} src="./lifehacker.svg" alt="" />
                        </div>
                        <div className='text-center'>
                            <img className="img-fluid p-2 mx-3" style={{ height: '200px', width: '300px' }} src="./disney.svg" alt="" />
                        </div>
                        <div className='text-center'>
                            <img className="img-fluid p-2 mx-3" style={{ height: '200px', width: '300px' }} src="./buzzfeed.svg" alt="" />
                        </div>
                        <div className='text-center'>
                            <img className="img-fluid p-2 mx-3" style={{ height: '200px', width: '300px' }} src="./marvel.svg" alt="" />
                        </div>
                    </div>
                </div>
            </div> */}
